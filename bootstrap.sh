...
if [ ! -f "$SKILLS_HOME/skills.md" ]; then
    printf '| name | url | local_path | load_at_startup | version |\n' > "$SKILLS_HOME/skills.md"
    printf '|------|-----|------------|-----------------|--------|\n' >> "$SKILLS_HOME/skills.md"
fi
